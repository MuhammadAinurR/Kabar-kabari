...
export default function LoginPage() {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            showToast({ message: `Welcome ${email}`, type: 'success' })
            navigate('/');
        } catch (error) {
            console.log(error)
                ...
                <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div>
                            ...
                            <Link
                                to="/"
                                className=" mt-2 flex w-full justify-center rounded-md text-gray-400 hover:text-indigo-500 px-3 py-1.5 text-sm font-semibold leading-6 shadow-sm border-indigo-200 hover:border-indigo-800 border-2 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                            >
                                Back to Homepage
                            </Link>
                        </div>
